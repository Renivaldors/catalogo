          ...
          PRODUTOS.map((produto) => {
            return (
              <div className="card">
                ...
                <p className="precoProduto"> <span className="precoNormal">{produto.original_price}</span>  <span className="precoPromocional">{produto.discounted_price}</span></p>

                </div>
                <a href={`https://wa.me/5538991686858?text=Ola Tenho interesse no produto${produto.name}`}>
